...
@section('pageSubTitle') {{trans('admin.notifications')}}
@endsection
...
@section('content')
    ...
    <div class="row" style="display:block">
        ...
        <div class="row breadcrumbs-top m-2">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{trans('admin.notifications')}}</h2>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="invalid-feedback">
                                                    {{trans('admin.please_enter_msg_ar')}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="invalid-feedback">
                                                    {{trans('admin.please_enter_msg_en')}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
